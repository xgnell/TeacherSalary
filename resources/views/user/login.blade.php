...
<head>
    ...
    <link href="{{ url('public') }}/assets/css/material-dashboard.css?v=1.2.1" rel="stylesheet" />
...
<body class="off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="{{ url('public') }}/assets/img/bkacad.jpg">
                            ...
                            <form method="POST" action="{{ route('home.login') }}">
                                ...
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="blue">
                                        <h4 class="card-title">Welcome Teacher</h4>
                                    </div>
...
<script src="{{ url('public') }}/assets/js/material-dashboard.js?v=1.2.1"></script>
