            ...
            @foreach ($teacher as $each)
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        {{-- javascript:void(0) --}}
                        <button data-toggle="modal" data-id="{{ $each->id }}" id="pay" data-target="#modelId"
                            class="btn btn-info">Set Salary</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
                ...
                <form method="POST" action="{{ route('salary.store') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="salary_overtime_per_hour"
                                id="salary_overtime_per_hour" aria-describedby="helpId"
                                placeholder="salary overtime per hour">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{ Auth::user()->id }}" class="form-control"
                                name="updated_by" id="updated_by" aria-describedby="helpId" readonly>
                        </div>
